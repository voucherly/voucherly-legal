...
This Acceptable Use Policy (“Policy”) governs your use of the services offered by Voucherly (“Cloud Service”) and our website(s).

1. ## General restrictions 
    You may not use, or facilitate or allow others to use, the Cloud Service:
